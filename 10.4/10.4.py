...
def max_sharpe_ratio_optimization(mean_returns, covar, rf, min_weight=0.1, max_weight=0.5):
    n = len(mean_returns)
...
def main():
    ...
    weights = max_sharpe_ratio_optimization(mean_returns, covar, rf, min_weight=0.1, max_weight=0.5)
